...
public record PermissionAssignments(Map<PermissionNode, PermissionState> permissions, Set<String> groups) {
    ...
    public static PermissionAssignments empty() {
        return new PermissionAssignments(Map.of(), Set.of());
    }
}
