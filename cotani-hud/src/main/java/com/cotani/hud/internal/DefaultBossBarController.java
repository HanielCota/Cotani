...
/**
 * Default implementation of {@link BossBarController}.
 */
@InternalApi
public final class DefaultBossBarController implements BossBarController {
    ...
    public DefaultBossBarController(PaperTaskScheduler scheduler) {
    ...
    public void close() {
        for (var bar : activeBars) {
            try {
                ...
                java.util.logging.Logger.getLogger(DefaultBossBarController.class.getName())
